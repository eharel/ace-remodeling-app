...
export const useZoom = ({
  ...
  // Get current state - use runOnJS to avoid reading during render
  ...
  // Check if at min/max scale - these will be called from worklets only
  ...
  // Pinch gesture - only activate when actually pinching
